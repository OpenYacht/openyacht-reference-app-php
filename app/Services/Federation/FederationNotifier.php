...
/**
 * Email alerts for the two federation events a human must act on: an
 * unsolicited introduction from an unknown node — provisional until
 * approved, so nobody noticing means nobody federating (FP-13) — and a
 * partner's node UUID changing, a possible domain takeover (FP-11,
 * whose conformance line requires notifying administrators).
 *
