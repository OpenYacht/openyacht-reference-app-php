...
/**
 * Validates the full wire schema at data entry: money as digit strings
 * (API-12), closed enums exactly as defined (LS-6), and builder slugs
 * against the vendored registry (LS-11).
 *
 * // listing-schema.md
 */
