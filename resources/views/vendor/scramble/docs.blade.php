...
{{-- AI/agent-friendly companions: the Stoplight UI above is rendered by
     JavaScript, so an agent fetching this page gets nothing — link the
     generated Markdown guide and the raw OpenAPI spec where both humans
     and crawlers can find them. --}}
<div style="position:fixed; bottom:14px; right:14px; z-index:50;
            display:flex; gap:8px; font:500 13px system-ui,-apple-system,sans-serif;">
    <a href="/docs/api/yachts.md"
       style="padding:6px 12px; border-radius:6px; background:#0f2d79; color:#fff; text-decoration:none;">Yacht API guide (AI)</a>
    <a href="/docs/api.json"
       style="padding:6px 12px; border-radius:6px; background:#1f2937; color:#fff; text-decoration:none;">OpenAPI JSON</a>
</div>
